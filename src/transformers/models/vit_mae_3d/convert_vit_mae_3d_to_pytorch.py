...
from transformers import ViTMAE3DConfig, ViTMAE3DFeatureExtractor, ViTMAE3DForPreTraining
...
def convert_vit_mae_3d_checkpoint(checkpoint_url, pytorch_dump_folder_path):
    ...
    feature_extractor = ViTMAE3DFeatureExtractor(size=config.image_size)
...
if __name__ == "__main__":
    ...
    convert_vit_mae_3d_checkpoint(args.checkpoint_url, args.pytorch_dump_folder_path)
